...
print("🔄 Creating and testing a simple fire detection model...")
...
for file_path, label in test_cases:
    try:
        ...
        print(f'{label:15} | Prediction: {prediction:.4f} | Fire: {fire_detected}')
    except Exception as e:
        print(f'{label:15} | Error: {e}')

print("\n🎯 Model ready! Expected behavior:")
print("- Fire images should have prediction < 0.5 (fire detected)")
print("- No-fire images should have prediction >= 0.5 (no fire)")